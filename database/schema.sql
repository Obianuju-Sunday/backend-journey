...
\restrict JX69xmJjIYimeMUkLGaujr4eJ5aKXCb1dzk8U0HXZn8NQBFXdzCP99kkx9MzBlY

-- Dumped from database version 14.24 (Ubuntu 14.24-1.pgdg22.04+2)
-- Dumped by pg_dump version 14.24 (Ubuntu 14.24-1.pgdg22.04+2)
...
--
-- Name: organisation_profiles; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.organisation_profiles OWNER TO postgres;
...
ALTER SEQUENCE public.organization_profiles_id_seq OWNED BY public.organisation_profiles.id;
...
CREATE TABLE public.student_skills (
    ...
    proficiency character varying(50) DEFAULT 'beginner'::character varying NOT NULL
);
...
CREATE TABLE public.users (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT users_role_check CHECK (((role)::text = ANY ((ARRAY['student'::character varying, 'organisation'::character varying, 'admin'::character varying])::text[])))
);
...
--
-- Name: organisation_profiles id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.organisation_profiles ALTER COLUMN id SET DEFAULT nextval('public.organization_profiles_id_seq'::regclass);
...
--
-- Name: organisation_profiles organization_profiles_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.organisation_profiles
    ADD CONSTRAINT organization_profiles_pkey PRIMARY KEY (id);


--
-- Name: organisation_profiles organization_profiles_user_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.internships
    ADD CONSTRAINT internships_organization_id_fkey FOREIGN KEY (organisation_id) REFERENCES public.organisation_profiles(id) ON DELETE CASCADE;


--
-- Name: organisation_profiles organization_profiles_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict JX69xmJjIYimeMUkLGaujr4eJ5aKXCb1dzk8U0HXZn8NQBFXdzCP99kkx9MzBlY
